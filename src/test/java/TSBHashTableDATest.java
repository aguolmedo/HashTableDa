...
public class TSBHashTableDATest {
    ...
    private TPUHashtable<String, Integer> table;

    @Before
    public void setup() {
        table = new TPUHashtable<>();
    }
    ...
    public void testEqualsAndHashcode() {
        TPUHashtable<String, Integer> other = new TPUHashtable<>();
    ...
    public void testClone() {
        addTestData();
        TPUHashtable<String, Integer> other = (TPUHashtable<String, Integer>) table.clone();
